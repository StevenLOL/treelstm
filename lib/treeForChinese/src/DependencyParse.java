...
//public static final String TAGGER_MODEL = "stanford-tagger/models/chinese-distsim.tagger";  
public static final String TAGGER_MODEL ="edu/stanford/nlp/models/pos-tagger/chinese-distsim/chinese-distsim.tagger";
///home/steven/gits/treelstm/lib/stanford-tagger/models/chinese-distsim.tagger
  //public static final String PARSER_MODEL = "edu/stanford/nlp/models/parser/nndep/english_SD.gz";
  public static final String PARSER_MODEL = "edu/stanford/nlp/models/parser/nndep/PTB_CoNLL_params.txt.gz";
  public static CRFClassifier<CoreLabel> segmenter=null;
public static List<HasWord> sentenceToTokens(String line) {
  	/*
    ...
    */
              if (segmenter ==null){
           System.err.println("sentenceToTokens in DependencyParse");
    Properties props = new Properties();
    String basedir="./lib/stanford-segmenter-2015-01-29/data/";
  ...
  public static void main(String[] args) throws Exception {
    ...
    while (stdin.hasNextLine()) {
      ...
      List<HasWord> tokens=sentenceToTokens(line);
     /* List<HasWord> tokens = new ArrayList<>();
      if (tokenize) {
